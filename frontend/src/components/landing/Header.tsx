...
export const Header: React.FC = () => {
  return (
    <header className="flex justify-between items-center px-4 py-2 sticky top-0 z-50 bg-transparent">
      ...
      <div className="flex gap-3 items-center">
        <a
          href="/login"
          className="px-3 py-1.5 rounded-lg border-[0.5px] border-white/10 bg-[#1c1c1c] text-white/80 uppercase text-[10px] font-medium tracking-wide hover:text-white transition-colors"
        >
          Log in
        </a>
        <a
