...
export const Footer: React.FC = () => {
  return (
    <footer className='w-full py-6 sm:py-8 lg:py-10 mt-10 sm:mt-16 lg:mt-20 relative z-10 bg-transparent'>
      <div className='max-w-7xl mx-auto px-4 sm:px-6 flex flex-col md:flex-row justify-between items-center gap-4 sm:gap-6'>
        ...
        <div className='flex gap-4 sm:gap-6 lg:gap-8 text-xs sm:text-sm text-white/60 font-sans'>
