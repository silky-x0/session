...
const MarqueeItem = ({ children }: { children: React.ReactNode }) => (
  <span className="mx-8 opacity-50 grayscale hover:grayscale-0 hover:opacity-100 transition-all duration-300">
    {children}
  </span>
);
...
export const Marquee: React.FC = () => {
  return (
    <section className="py-20 overflow-hidden w-full relative">
      <h2 className="text-center font-bold font-sans uppercase text-sm tracking-widest text-white/40 mb-10">
