...
const MarqueeItem = ({ children }: { children: React.ReactNode }) => (
  <span className='mx-3 sm:mx-6 opacity-50 grayscale hover:grayscale-0 hover:opacity-100 transition-all duration-300'>
    {children}
  </span>
);
...
export const Marquee: React.FC = () => {
  return (
    <section className='pt-12 sm:pt-16 lg:pt-24 pb-6 sm:pb-10 py-6 overflow-hidden w-full relative'>
      <h2 className='text-center font-bold font-sans uppercase text-[10px] sm:text-xs tracking-widest text-white/40 mb-4 sm:mb-6 px-4'>
