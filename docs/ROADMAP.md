...
- [ ] Theme system (Light / Dark / High Contrast / Zen Mode)
- [ ] Prettier integration ("Format Code" button)
- [ ] Recent sessions list on landing page
...
- [ ] Performance metrics (execution time, memory usage graphs)
- [ ] Attention pings (visual ripple on a line to draw partner's focus)
- [ ] Driver/Navigator indicator toggle
